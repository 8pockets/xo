...
```sh
$ go get -u github.com/8pockets/xo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/8pockets/xo
```
...
$ cp "$GOPATH/src/github.com/8pockets/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/8pockets/xo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/8pockets/xo
```
